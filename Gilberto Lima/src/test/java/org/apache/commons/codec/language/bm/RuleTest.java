...
public class RuleTest {
    ...
    void testSubSequenceWorks() {
        ...
        assertEquals("ab", a_b.getPhonemeText().subSequence(0, 2));
        assertEquals("a", a_b.getPhonemeText().subSequence(0, 1));
        assertEquals("b", a_b.getPhonemeText().subSequence(1, 2));
        ...
        assertEquals("c", cd_ef.getPhonemeText().subSequence(0, 1));
        assertEquals("d", cd_ef.getPhonemeText().subSequence(1, 2));
        assertEquals("e", cd_ef.getPhonemeText().subSequence(2, 3));
        assertEquals("f", cd_ef.getPhonemeText().subSequence(3, 4));
        assertEquals("cd", cd_ef.getPhonemeText().subSequence(0, 2));
        assertEquals("de", cd_ef.getPhonemeText().subSequence(1, 3));
        assertEquals("ef", cd_ef.getPhonemeText().subSequence(2, 4));
        assertEquals("cde", cd_ef.getPhonemeText().subSequence(0, 3));
        assertEquals("def", cd_ef.getPhonemeText().subSequence(1, 4));
        assertEquals("cdef", cd_ef.getPhonemeText().subSequence(0, 4));
        ...
        assertEquals("a", a_b_cd.getPhonemeText().subSequence(0, 1));
        assertEquals("b", a_b_cd.getPhonemeText().subSequence(1, 2));
        assertEquals("c", a_b_cd.getPhonemeText().subSequence(2, 3));
        assertEquals("d", a_b_cd.getPhonemeText().subSequence(3, 4));
        assertEquals("ab", a_b_cd.getPhonemeText().subSequence(0, 2));
        assertEquals("bc", a_b_cd.getPhonemeText().subSequence(1, 3));
        assertEquals("cd", a_b_cd.getPhonemeText().subSequence(2, 4));
        assertEquals("abc", a_b_cd.getPhonemeText().subSequence(0, 3));
        assertEquals("bcd", a_b_cd.getPhonemeText().subSequence(1, 4));
        assertEquals("abcd", a_b_cd.getPhonemeText().subSequence(0, 4));
    }
}
